...
function hiding() {
    ...
    choose({
        'Asian parents are usually very homophobic.': hiding2,
        'I don\'t know... I guess I haven\'t tried...': hiding2,
        'They don\'t support anything but STUDYING.': hiding2
    });

}

function hiding2(message) {
    ...
    choose({
        'Tonight?! Heck no.': hiding3,
        'Sigh... I\'ll try my best.': hiding3,
        'I\'ll just carefully hint at it.': hiding3
    });

}

function hiding3(message) {
